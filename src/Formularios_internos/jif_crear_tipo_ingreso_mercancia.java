 ...
 */
public class jif_crear_tipo_ingreso_mercancia extends javax.swing.JDialog {

    /**
     * Creates new form jif_crear_marca
     */
    public jif_crear_tipo_ingreso_mercancia() {
        initComponents();
        txt_id.setText(DB_consultas_R_D.cargarId("tipo_ingreso"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        if (txt_nombre.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Por favor ingrese un nombre para el tipo de ingreso");
        } else {

            if (DB_consultas_R_D.consultar_existencia_campo_String("nombre", txt_nombre.getText(), "tipo_ingreso") > 0) {
                JOptionPane.showMessageDialog(this, "El tipo de ingreso ya se encuentra creado");
                txt_nombre.setText("");
                txt_nombre.requestFocus();
            } else {

                DB_Tipos_ingresos_mercancia dbmarcas = new DB_Tipos_ingresos_mercancia();
                Tipo_ingresos_mercancia marca = new Tipo_ingresos_mercancia();
                try {
                    marca.setId(Integer.parseInt(txt_id.getText()));
                } catch (Exception e) {
                }
                marca.setNombre(txt_nombre.getText());

                if (DB_consultas_R_D.consultarId(txt_id.getText(), "tipo_ingreso") == 1) {
                    dbmarcas.Actualizar(marca);
                } else {
                    dbmarcas.Guardar(marca);
                }
                limpiar();
                txt_id.setText(DB_consultas_R_D.cargarId("tipo_ingreso"));
                ...
                frm_tipo_ingresos.btn_actualizar.doClick();
            }
        }
