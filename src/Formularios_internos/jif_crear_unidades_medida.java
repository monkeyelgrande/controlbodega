...
import Formularios.frm_unidades;
import Metodos.metodos;
import conexiondb.DB_Unidades;
 ...
 */
public class jif_crear_unidades_medida extends javax.swing.JDialog {

    /**
     * Creates new form jif_crear_marca
     */
    public jif_crear_unidades_medida() {
        initComponents();
        txt_id.setText(DB_consultas_R_D.cargarId("unidades_medidas"));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        if (txt_nombre.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Por favor ingrese un nombre para la unidad de medida");
        } else {

            if (DB_consultas_R_D.consultar_existencia_campo_String("nombre", txt_nombre.getText(), "unidades_medidas") > 0) {
                JOptionPane.showMessageDialog(this, "la unidad de medida ya se encuentra creada");
                txt_nombre.setText("");
                txt_nombre.requestFocus();
            } else {

                DB_Unidades dbmarcas = new DB_Unidades();
                Unidades marca = new Unidades();
                try {
                ...
                if (DB_consultas_R_D.consultarId(txt_id.getText(), "unidades_medidas") == 1) {
                ...
                frm_unidades.btn_actualizar.doClick();
            }
        }
