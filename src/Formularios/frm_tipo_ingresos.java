...
import Formularios_internos.jif_crear_tipo_ingreso_mercancia;
 ...
 */
public class frm_tipo_ingresos extends javax.swing.JInternalFrame {
    ...
    public frm_tipo_ingresos() {
        initComponents();
        mostrar();
        TamanosTablaAbonos();
        Metodos.metodos.TablaAptaParaBusquedaAndSSM(jtabla_tipo_ingreso);
        jtabla_tipo_ingreso.addMouseListener(new java.awt.event.MouseAdapter() {
    ...
    public void TamanosTablaAbonos() {
        jtabla_tipo_ingreso.getTableHeader().setReorderingAllowed(false);
        TableColumnModel columnModel = jtabla_tipo_ingreso.getColumnModel();
    ...
    public void mostrar() {
        ...
        ResultSet rs = DB_consultas_R_D.getTabla("select * from tipo_ingreso order by id");
        ...
        try {
            ...
            jtabla_tipo_ingreso.setModel(modelo);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jtabla_tipo_ingreso = new org.jdesktop.swingx.JXTable();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Tipo ingresos mercancia");
        ...
        jtabla_tipo_ingreso.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtabla_tipo_ingreso.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jtabla_tipo_ingreso.setRowHeight(32);
        jtabla_tipo_ingreso.setSelectionBackground(new java.awt.Color(0, 153, 153));
        jScrollPane2.setViewportView(jtabla_tipo_ingreso);
        ...
        jLabel13.setText("Tipos de ingreso de mercancia");
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearActionPerformed
        jif_crear_tipo_ingreso_mercancia frm = new jif_crear_tipo_ingreso_mercancia(); // este es un jdialog
        frm.show();
        jif_crear_tipo_ingreso_mercancia.txt_nombre.requestFocus();
    }//GEN-LAST:event_btn_crearActionPerformed

    public int consultarId(String id) {
        ResultSet rs = DB_consultas_R_D.getTabla("select count(id) as id from tipo_ingreso where id = " + id + "");
        try {
            while (rs.next()) {
                // añade los resultado a al modelo de tabla
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        int fila = jtabla_tipo_ingreso.getSelectedRow();
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione un registro");
        } else {
            int dialogButton = JOptionPane.YES_NO_OPTION;
            int dialogResult = JOptionPane.showConfirmDialog(null, "Desea eliminar este tipo de ingreso?", "Alerta", dialogButton);
            if (dialogResult == JOptionPane.YES_OPTION) {

                try {
                    DefaultTableModel modelo = (DefaultTableModel) jtabla_tipo_ingreso.getModel();
                    String id = (String) jtabla_tipo_ingreso.getValueAt(fila, 0);//suponiendo que el id lo muestras en la primera columna
                    DB_consultas_R_D.eliminar("tipo_ingreso", id);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (fila < 0) {
            ...
            String id = (String) jtabla_tipo_ingreso.getValueAt(fila, 0);
            ResultSet rs = DB_consultas_R_D.getTabla("select * from tipo_ingreso where id =" + id);
            jif_crear_tipo_ingreso_mercancia frm = new jif_crear_tipo_ingreso_mercancia();
            try {
                while (rs.next()) {
                    jif_crear_tipo_ingreso_mercancia.txt_id.setText(rs.getString("id"));
                    jif_crear_tipo_ingreso_mercancia.txt_nombre.setText(rs.getString("nombre"));
                }
                rs.close();
    ...
    private void txt_FiltroKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_FiltroKeyTyped
        ...
        trsFiltro = new TableRowSorter(jtabla_tipo_ingreso.getModel());
        jtabla_tipo_ingreso.setRowSorter(trsFiltro);
    }//GEN-LAST:event_txt_FiltroKeyTyped

    public void actualizar() {
        for (int i = 0; i < jtabla_tipo_ingreso.getRowCount(); i++) {
            modelo.removeRow(i);
            i -= 1;
        }
        ResultSet rs = DB_consultas_R_D.getTabla("select * from tipo_ingreso order by id");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_tipo_ingresos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_tipo_ingresos().setVisible(true);
            }
        });
    }
    ...
    private org.jdesktop.swingx.JXTable jtabla_tipo_ingreso;
