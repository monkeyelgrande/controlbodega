...
import Formularios_internos.jif_crear_bodegas;
 ...
 */
public class frm_bodegas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jtabla_clientes.setRowHeight(32);
                ...
                .addGroup(jpnl_tablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpnl_tablaLayout.createSequentialGroup()
                        .addGroup(jpnl_tablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jpnl_tablaLayout.createSequentialGroup()
                                .addComponent(txt_Filtro, javax.swing.GroupLayout.PREFERRED_SIZE, 440, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearActionPerformed
        jif_crear_bodegas frm = new jif_crear_bodegas();
        frm.show();
        jif_crear_bodegas.txt_nombre.requestFocus();
    }//GEN-LAST:event_btn_crearActionPerformed

    public int consultarId(String id) {
        ResultSet rs = DB_consultas_R_D.getTabla("select count(id) as id from bodegas where id = " + id + "");
        try {
            while (rs.next()) {
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        if (fila == -1) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Desea eliminar esta bodega?", "Alerta", dialogButton);
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    DB_consultas_R_D.eliminar("bodegas", id);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (fila < 0) {
            ...
            ResultSet rs = DB_consultas_R_D.getTabla("select * from bodegas where id =" + id);
            jif_crear_bodegas frm = new jif_crear_bodegas();
//            frm_main.escritorio.add(frm);
//            frm.toFront();
            try {
                while (rs.next()) {
                    jif_crear_bodegas.txt_id.setText(rs.getString("id"));
                    jif_crear_bodegas.txt_nombre.setText(rs.getString("nombre"));

                    if (rs.getInt("imprime") == 0) {
                        jif_crear_bodegas.rbtn_NO_imprime.setSelected(true);
                    } else {
...
//            frm.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
    ...
    public void filtro() {
        trsFiltro.setRowFilter(RowFilter.regexFilter(txt_Filtro.getText(), 1));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_bodegas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_bodegas().setVisible(true);
            }
        });
    }
