 ...
 * @author M-Work
 */
public class EstiloTablasHeader extends DefaultTableCellRenderer {

    public EstiloTablasHeader() {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        setFont(new Font("Roboto", Font.BOLD, 16)); // Fuente moderna, negrita y tamaño 16
    ...
    public Dimension getPreferredSize() {
        ...
        d.height = 48; // Altura del encabezado estilo Material Design
        return d;
    }
