...
public class Bodegas {
    ...
    public boolean isEntregaAutomatica() {
        return entregaAutomatica;
    }

    public void setEntregaAutomatica(boolean entregaAutomatica) {
        this.entregaAutomatica = entregaAutomatica;
    }
