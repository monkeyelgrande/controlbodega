 ...
 * @modifier Gemini
 */
public class ImprimirPNG_caja_diaria {

    // --- Variables de datos del recibo ---
    private final String nombre_negocio, nit, direccion, no_factura, fecha_hora, nombre_vendedor, total, fondo, cuenta, descripcion, tipo;
    ...
    public ImprimirPNG_caja_diaria(String fecha, String no_factura, String nombre_vendedor, String total, String fondo, String cuenta, String descripcion, String tipo) {
    ...
    private void dibujarRecibo(Graphics2D g2d, double ancho) {
        try {
            ...
            g2d.drawString("Contacto: " + nombre_vendedor, MARGEN_IZQUIERDO, y);
            y += INTERLINEADO;

            g2d.setFont(FUENTE_NORMAL_BOLD);
            g2d.drawString("CUENTA:     " + cuenta, MARGEN_IZQUIERDO, y);
            y += INTERLINEADO;
            ...
            g2d.setFont(FUENTE_SEPARADOR);
            g2d.drawString("Fondo:     " + fondo, MARGEN_IZQUIERDO, y);
            y += INTERLINEADO;
    ...
    private void guardarImagenComoPNG(BufferedImage image) throws IOException {
        ...
        fileChooser.setSelectedFile(new File(tipo + "_" + this.no_factura + ".png"));
