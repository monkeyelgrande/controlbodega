 ...
 */
public class frm_cuentas_egresos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Cuentas Egresos");
        ...
        if (fila == -1) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    DB_consultas_R_D.eliminar("cuentas_egresos", id);
...
//            frm.toFront();
            try {
                while (rs.next()) {
                    jif_crear_cuenta_egresos.txt_id.setText(rs.getString("id"));
                    jif_crear_cuenta_egresos.txt_nombre.setText(rs.getString("nombre"));

                    jif_crear_cuenta_egresos.chk_predeterminado.setSelected(false);
                    if (rs.getInt("predeterminado") == 1) {
                        jif_crear_cuenta_egresos.chk_predeterminado.setSelected(true);
                    }
                }
                rs.close();

            } catch (SQLException ex) {
                Logger.getLogger(frm_cuentas_egresos.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            ver = false;
            frm.show();
            jif_crear_cuenta_egresos.txt_nombre.requestFocus();
