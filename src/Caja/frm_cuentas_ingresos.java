 ...
 */
public class frm_cuentas_ingresos extends javax.swing.JInternalFrame {
    ...
    public frm_cuentas_ingresos() {
        this(1);
    }

    public frm_cuentas_ingresos(int idCaja) {
        this.idCaja = idCaja;
        initComponents();
        if (idCaja == 2) {
            setTitle("Cuentas - Caja Dos");
            jLabel13.setText("Cuentas Ingresos - Caja Dos");
        }
        actualizar();
        TamanosTablaAbonos();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Cuentas Ingresos");
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearActionPerformed
        jif_crear_cuenta_ingresos frm = new jif_crear_cuenta_ingresos(idCaja);
...
//        frm.setVisible(true);
        ...
        if (fila == -1) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    DB_consultas_R_D.eliminar("cuentas_ingresos", id);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (fila < 0) {
            ...
            ResultSet rs = DB_consultas_R_D.getTabla("select * from cuentas_ingresos where id =" + id);
            jif_crear_cuenta_ingresos frm = new jif_crear_cuenta_ingresos(idCaja);
//            frm_main.escritorio.add(frm);
//            frm.toFront();
            try {
                while (rs.next()) {
                    jif_crear_cuenta_ingresos.txt_id.setText(rs.getString("id"));
                    jif_crear_cuenta_ingresos.txt_nombre.setText(rs.getString("nombre"));

                    jif_crear_cuenta_ingresos.chk_predeterminado.setSelected(false);
                ...
                Logger.getLogger(frm_cuentas_ingresos.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            ver = false;
            frm.show();
            jif_crear_cuenta_ingresos.txt_nombre.requestFocus();
    ...
    public void actualizar() {
        ...
        ResultSet rs = DB_consultas_R_D.getTabla("select * from cuentas_ingresos where id_caja = " + idCaja + " order by id");
        ...
        try {
            while (rs.next()) {
                ...
                modelo.addRow(new Object[]{rs.getString("id"), rs.getString("nombre"), pre});
            }
            rs.close();
