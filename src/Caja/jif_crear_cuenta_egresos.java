...
import conexiondb.DBcuentas_Egresos;
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        if (txt_nombre.getText().equals("")) {
            ...
            if (DB_consultas_R_D.consultar_existencia_campo_String("nombre", txt_nombre.getText(), "cuentas_egresos") > 0 && btn_guardar.getText().equals("Guardar")) {
                ...
                DBcuentas_Egresos dbcuentas = new DBcuentas_Egresos();

                Cuentas_Egresos cuenta = new Cuentas_Egresos();
                ...
                frm_cuentas_egresos.btn_actualizar.doClick();
            }
        }
