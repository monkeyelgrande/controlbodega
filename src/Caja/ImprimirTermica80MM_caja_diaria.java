 ...
 * @author mktec
 */
public class ImprimirTermica80MM_caja_diaria {

    String nombre_negocio, nit, direccion, no_factura, fecha_hora, nombre_vendedor, total, fondo, cuenta, descripcion, tipo;
    double middleHeight = 0.0;

    public ImprimirTermica80MM_caja_diaria(String fecha, String no_factura, String nombre_vendedor, String total, String fondo, String cuenta, String descripcion, String tipo) {
    ...
    public class Printables implements Printable {
        ...
        public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
            ...
            if (pageIndex == 0) {
                ...
                int nit_posicion = (int) ((width - metrics.stringWidth(nit)) / 2);;
                ...
                try {
                    ...
                    y += yShift;
                    g2d.drawString(nit, nit_posicion, y);
                    y += yShift;
                    ...
                    y += yShift;
                    g2d.drawString("Tipo: " + tipo, no_fac_posicion, y);
                    y += yShift;
                    g2d.drawString("Recibo No. " + no_factura, no_fac_posicion, y);
                    y += yShift;
                    g2d.setFont(new Font("Arial", Font.BOLD, 10));
                    g2d.drawString("Fecha", 100, y);
                    y += yShift;
                    ...
                    y += yShift;
                    g2d.setFont(new Font("Arial", Font.BOLD, 12));
                    g2d.drawString("TOTAL:     " + total, 12, y);
                    y += yShift;
                    g2d.setFont(new Font("Arial", Font.PLAIN, 12));
                    g2d.drawString("Fondo:     " + fondo, 12, y);
                    y += yShift;
                    g2d.setFont(new Font("Arial", Font.BOLD, 12));
                    g2d.drawString("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■", 12, y);
                    y += yShift;
