...
import Creditos.jif_crear_cuenta;
...
public class frm_cuentas extends javax.swing.JInternalFrame {
    ...
    public void mostrar() {
        ...
        ResultSet rs = DB_consultas_R_D.getTabla("select * from cuentas order by id");
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Cuentas Créditos");
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearActionPerformed
        jif_crear_cuenta frm = new jif_crear_cuenta();
...
//        frm.setVisible(true);
        frm.show();
        jif_crear_cuenta.txt_nombre.requestFocus();
    }//GEN-LAST:event_btn_crearActionPerformed

    public int consultarId(String id) {
        ResultSet rs = DB_consultas_R_D.getTabla("select count(id) as id from cuentas where id = " + id + "");
        try {
            while (rs.next()) {
                // añade los resultado a al modelo de tabla
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        if (fila == -1) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Desea eliminar esta cuenta?", "Alerta", dialogButton);
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    DB_consultas_R_D.eliminar("cuentas", id);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (fila < 0) {
            ...
            ResultSet rs = DB_consultas_R_D.getTabla("select * from cuentas where id =" + id);
            jif_crear_cuenta frm = new jif_crear_cuenta();
//            frm_main.escritorio.add(frm);
//            frm.toFront();
            try {
                while (rs.next()) {
                    jif_crear_cuenta.txt_id.setText(rs.getString("id"));
                    jif_crear_cuenta.txt_nombre.setText(rs.getString("nombre"));
                }
                rs.close();
...
//            frm.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_cuentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_cuentas().setVisible(true);
            }
        });
    }
