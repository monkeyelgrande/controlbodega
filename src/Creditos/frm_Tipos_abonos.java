...
import Creditos.jif_crear_tipos_abonos;
 ...
 */
public class frm_Tipos_abonos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(jpnl_tablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpnl_tablaLayout.createSequentialGroup()
                        .addGroup(jpnl_tablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jpnl_tablaLayout.createSequentialGroup()
                                .addComponent(txt_Filtro, javax.swing.GroupLayout.PREFERRED_SIZE, 436, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel13.setText("Tipos de abonos");
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearActionPerformed
        jif_crear_tipos_abonos frm = new jif_crear_tipos_abonos();
        frm.show();
        jif_crear_tipos_abonos.txt_nombre.requestFocus();
    }//GEN-LAST:event_btn_crearActionPerformed
    
    public int consultarId(String id) {
        ResultSet rs = DB_consultas_R_D.getTabla("select count(id) as id from tipos_abonos where id = " + id + "");
        try {
            while (rs.next()) {
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        if (fila == -1) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Desea eliminar este tipo de abono?", "Alerta", dialogButton);
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    DB_consultas_R_D.eliminar("tipos_abonos", id);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        ...
        if (fila < 0) {
            ...
            ResultSet rs = DB_consultas_R_D.getTabla("select * from tipos_abonos where id =" + id);
            jif_crear_tipos_abonos frm = new jif_crear_tipos_abonos();
//            frm_main.escritorio.add(frm);
//            frm.toFront();
            try {
                while (rs.next()) {
                    jif_crear_tipos_abonos.txt_id.setText(rs.getString("id"));
                    jif_crear_tipos_abonos.txt_nombre.setText(rs.getString("nombre"));
                    jif_crear_tipos_abonos.jbox_color.setSelectedItem(rs.getString("color"));

                    if (rs.getInt("anticipo") == 0) {
...
//            frm.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Tipos_abonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Tipos_abonos().setVisible(true);
            }
        });
    }
