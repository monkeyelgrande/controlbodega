...
/**
 * Reporte: cabeceras de ingresos entre fechas con observacion y usuario,
 * filtrable por usuario (modulo Precios; portado del
 * jd_Ingreso_productosEntreFechasXProducto de productos-agroinsumos,
 * adaptado a las tablas ingresos_productos_*).
 *
 * @author Monkeyelgrande
 */
public class jd_reporte_ingresos_x_producto extends javax.swing.JDialog {
    ...
    public jd_reporte_ingresos_x_producto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void TamanosTablaVentas(TableColumnModel cm) {
        ...
        cm.getColumn(3).setPreferredWidth(400);
    ...
    private void initComponents() {
        ...
        setTitle("Ingresos de productos entre fechas (por usuario)");
    ...
    private void btn_consultarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        modeloBalance.setColumnIdentifiers(new Object[]{"# ingreso", "Proveedor", "Fecha", "Observación", "Usuario"});
